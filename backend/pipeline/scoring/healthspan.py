...
#: Outdoor scenes that count as green/blue space (White 2019); street/parking_lot/stadium do not.
NATURE_SCENES: frozenset[str] = frozenset({"park", "trail", "backyard", "beach", "campus_outdoor"})
