import type { BiometricOrigin, Biometrics, BiometricsMulti, Conversation, Decision, DecisionAction, Episode, Healthspan, HealthspanFactor, PendingCheck, Persona, ProfileLine, Provenance, Question, Scores, SeededDay, SeededMetricRow, Status, Tick, TodaySummary, WearablesStatus } from "./types";
...
export const mockConversations: Conversation[] = [
 {id:"c_active",opened_t:now-12,closed_t:null,reason:"food ownership",topic:"the drink on the desk",decision_id:"d_0011",episode_id:"e_0006",state:"active",turns:[{t:now-10,role:"agent",text:"Is that drink yours?",kind:"question"}],settled:null,close_reason:null},
 {id:"c_count",opened_t:now-660,closed_t:now-625,reason:"alcohol count",topic:"the drinks with dinner",decision_id:"d_0009",episode_id:"e_0003",state:"closed",turns:[{t:now-658,role:"agent",text:"How many drinks did you have?",kind:"question"},{t:now-638,role:"wearer",text:"Two.",heard:true},{t:now-626,role:"agent",text:"Got it.",kind:"statement"}],settled:{confirmed:true,count:2,food_type:null,note:null},close_reason:"done"},
 {id:"c_statement",opened_t:now-1810,closed_t:now-1807,reason:"screen break",topic:"the long screen session",decision_id:"d_0006",episode_id:"e_0002",state:"closed",turns:[{t:now-1808,role:"agent",text:"You have been on screen for over an hour — worth standing up.",kind:"statement"}],settled:null,close_reason:"done"},
 {id:"c_silent",opened_t:now-2470,closed_t:now-2440,reason:"meal details",topic:"whether that was lunch",decision_id:"d_0004",episode_id:"e_0002",state:"closed",turns:[{t:now-2468,role:"agent",text:"Was that lunch?",kind:"question"},{t:now-2442,role:"wearer",text:"",heard:false}],settled:null,close_reason:"nothing_heard"},
];
